...
public class Controller06 implements Initializable {
        ...
        public void checkCollisionPaddle(Rectangle paddle) {
            if (circle.getBoundsInParent().intersects(paddle.getBoundsInParent())) {
                ...
                if (rightBorder || leftBorder) {
                    ...
                    if (rightBorder) {
                        circle.setLayoutX(paddle.getLayoutX() + paddle.getWidth() + circle.getRadius());
                    } else {
                        circle.setLayoutX(paddle.getLayoutX() - circle.getRadius());
                    }
                }
